 ...
 * 
 * @package SurveySez
 * @author Ted Miller <ted.miller92@gmail.com>
...
if(isset($_GET['id']) && (int)$_GET['id'] > 0){ #proper data must be on querystring
	...
	myRedirect(VIRTUAL_PATH . "surveys/index.php"); // send the user back to a safe page
}

//sql statement to select individual item
// keep this one here for reference
// $sql = "select MuffinName,Description,MetaDescription,MetaKeywords,Price from test_Muffins where MuffinID = " . $myID;

$sql = "SELECT Title, Description, DateAdded FROM winter2022_surveys WHERE SurveyID = " . $myID;
...
{#only load data if record found
	$config->titleTag = $Title; #overwrite PageTitle with survey info
}
/*
...
{#records exist - show muffin!
    ...
    echo '<div align="center">There is no survey with that ID </div>';
